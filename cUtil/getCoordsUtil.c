...
#define __PYX_HAVE__getCoordsUtil
#define __PYX_HAVE_API__getCoordsUtil
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
 ...
 * FTYPE = np.float64
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_13getCoordsUtil_DTYPE_t;

/* "getCoordsUtil.pyx":10
 * 
 * FTYPE = np.float64
 ...
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_13getCoordsUtil_FTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'getCoordsUtil' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_13getCoordsUtil_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_13getCoordsUtil_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_13getCoordsUtil_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_13getCoordsUtil_DTYPE_t), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_13getCoordsUtil_FTYPE_t = { "FTYPE_t", NULL, sizeof(__pyx_t_13getCoordsUtil_FTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "getCoordsUtil"
extern int __pyx_module_is_main_getCoordsUtil;
int __pyx_module_is_main_getCoordsUtil = 0;

/* Implementation of 'getCoordsUtil' */
...
static const char __pyx_k_imid[] = "imid";
...
static const char __pyx_k_nQuery[] = "nQuery";
static const char __pyx_k_seqPos[] = "seqPos";
static const char __pyx_k_float64[] = "float64";
static const char __pyx_k_queryPos[] = "queryPos";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_getCoordsUtil[] = "getCoordsUtil";
static const char __pyx_k_getCoordsUtil_pyx[] = "getCoordsUtil.pyx";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_getInterpolatedCoordsSort[] = "getInterpolatedCoordsSort";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_numpy_core_multiarray_failed_to[] = "numpy.core.multiarray failed to import";
static const char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static const char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static const char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static const char __pyx_k_error_getInterpolatedCoords_sequ[] = "error: getInterpolatedCoords: sequence position and coordinate list lengths mismatch.";
...
static PyObject *__pyx_kp_s_error_getInterpolatedCoords_sequ;
static PyObject *__pyx_n_s_f;
static PyObject *__pyx_n_s_file;
static PyObject *__pyx_n_s_float64;
static PyObject *__pyx_n_s_getCoordsUtil;
static PyObject *__pyx_kp_s_getCoordsUtil_pyx;
static PyObject *__pyx_n_s_getInterpolatedCoordsSort;
static PyObject *__pyx_n_s_i;
static PyObject *__pyx_n_s_imax;
static PyObject *__pyx_n_s_imid;
...
static PyObject *__pyx_n_s_nQuery;
...
static PyObject *__pyx_n_s_queryPos;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_seqPos;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_13getCoordsUtil_getInterpolatedCoordsSort(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_seqPos, PyArrayObject *__pyx_v_coords, PyArrayObject *__pyx_v_queryPos); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_13getCoordsUtil_1getInterpolatedCoordsSort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13getCoordsUtil_1getInterpolatedCoordsSort = {"getInterpolatedCoordsSort", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13getCoordsUtil_1getInterpolatedCoordsSort, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13getCoordsUtil_1getInterpolatedCoordsSort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_seqPos = 0;
  PyArrayObject *__pyx_v_coords = 0;
  PyArrayObject *__pyx_v_queryPos = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("getInterpolatedCoordsSort (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_seqPos,&__pyx_n_s_coords,&__pyx_n_s_queryPos,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seqPos)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_coords)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("getInterpolatedCoordsSort", 1, 3, 3, 1); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_queryPos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("getInterpolatedCoordsSort", 1, 3, 3, 2); __PYX_ERR(0, 17, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "getInterpolatedCoordsSort") < 0)) __PYX_ERR(0, 17, __pyx_L3_error)
      }
    ...
    __pyx_v_seqPos = ((PyArrayObject *)values[0]);
    __pyx_v_coords = ((PyArrayObject *)values[1]);
    __pyx_v_queryPos = ((PyArrayObject *)values[2]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("getInterpolatedCoordsSort", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 17, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("getCoordsUtil.getInterpolatedCoordsSort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_seqPos), __pyx_ptype_5numpy_ndarray, 1, "seqPos", 0))) __PYX_ERR(0, 17, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_coords), __pyx_ptype_5numpy_ndarray, 1, "coords", 0))) __PYX_ERR(0, 18, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_queryPos), __pyx_ptype_5numpy_ndarray, 1, "queryPos", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  __pyx_r = __pyx_pf_13getCoordsUtil_getInterpolatedCoordsSort(__pyx_self, __pyx_v_seqPos, __pyx_v_coords, __pyx_v_queryPos);
...
static PyObject *__pyx_pf_13getCoordsUtil_getInterpolatedCoordsSort(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_seqPos, PyArrayObject *__pyx_v_coords, PyArrayObject *__pyx_v_queryPos) {
  ...
  unsigned int __pyx_v_imin;
  unsigned int __pyx_v_imax;
  unsigned int __pyx_v_imid;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_queryPos;
  __Pyx_Buffer __pyx_pybuffer_queryPos;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_seqPos;
  __Pyx_Buffer __pyx_pybuffer_seqPos;
  ...
  size_t __pyx_t_31;
  size_t __pyx_t_32;
  __Pyx_RefNannySetupContext("getInterpolatedCoordsSort", 0);
  ...
  __pyx_pybuffer_seqPos.pybuffer.buf = NULL;
  __pyx_pybuffer_seqPos.refcount = 0;
  __pyx_pybuffernd_seqPos.data = NULL;
  __pyx_pybuffernd_seqPos.rcbuffer = &__pyx_pybuffer_seqPos;
  ...
  __pyx_pybuffer_queryPos.pybuffer.buf = NULL;
  __pyx_pybuffer_queryPos.refcount = 0;
  __pyx_pybuffernd_queryPos.data = NULL;
  __pyx_pybuffernd_queryPos.rcbuffer = &__pyx_pybuffer_queryPos;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_seqPos.rcbuffer->pybuffer, (PyObject*)__pyx_v_seqPos, &__Pyx_TypeInfo_nn___pyx_t_13getCoordsUtil_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
  __pyx_pybuffernd_seqPos.diminfo[0].strides = __pyx_pybuffernd_seqPos.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_seqPos.diminfo[0].shape = __pyx_pybuffernd_seqPos.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_coords.rcbuffer->pybuffer, (PyObject*)__pyx_v_coords, &__Pyx_TypeInfo_nn___pyx_t_13getCoordsUtil_FTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_queryPos.rcbuffer->pybuffer, (PyObject*)__pyx_v_queryPos, &__Pyx_TypeInfo_nn___pyx_t_13getCoordsUtil_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
  __pyx_pybuffernd_queryPos.diminfo[0].strides = __pyx_pybuffernd_queryPos.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_queryPos.diminfo[0].shape = __pyx_pybuffernd_queryPos.rcbuffer->pybuffer.shape[0];

  /* "getCoordsUtil.pyx":22
 * 
 ...
 */
  __pyx_v_nPos = (__pyx_v_seqPos->dimensions[0]);

  /* "getCoordsUtil.pyx":23
 *   cdef unsigned int i, j, k, a, b
 *   cdef int nPos = seqPos.shape[0]
 *   cdef int nQuery = queryPos.shape[0]             # <<<<<<<<<<<<<<
 *   cdef int d, dMin, dA, dB
 ...
 */
  __pyx_v_nQuery = (__pyx_v_queryPos->dimensions[0]);

  /* "getCoordsUtil.pyx":25
 *   cdef int nQuery = queryPos.shape[0]
 *   cdef int d, dMin, dA, dB
 *   cdef int dMax = seqPos.max()             # <<<<<<<<<<<<<<
 *   cdef float f
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_seqPos), __pyx_n_s_max); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_nQuery); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_p.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_13getCoordsUtil_FTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 * 
 */
  __pyx_t_7 = ((__pyx_v_nPos != (__pyx_v_coords->dimensions[0])) != 0);
  if (__pyx_t_7) {

    /* "getCoordsUtil.pyx":31
 * 
 *   if nPos != coords.shape[0]:
 *     print 'error: getInterpolatedCoords: sequence position and coordinate list lengths mismatch.'             # <<<<<<<<<<<<<<
 * 
 * 
 */
    if (__Pyx_PrintOne(0, __pyx_kp_s_error_getInterpolatedCoords_sequ) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 *     imin = 0
 */
  __pyx_t_4 = __pyx_v_nQuery;
  __pyx_t_8 = __pyx_t_4;
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_k = __pyx_t_9;

    /* "getCoordsUtil.pyx":35
 * 
 *   for k in range(nQuery):
 *     d = dMax             # <<<<<<<<<<<<<<
 *     imin = 0
 *     imax = nPos
 */
    __pyx_v_d = __pyx_v_dMax;

    /* "getCoordsUtil.pyx":36
 *   for k in range(nQuery):
 *     d = dMax
 *     imin = 0             # <<<<<<<<<<<<<<
 *     imax = nPos
 ...
 *     while (imax > imin + 1):
 */
    __pyx_v_imax = __pyx_v_nPos;

    /* "getCoordsUtil.pyx":38
 *     imin = 0
 *     imax = nPos
 *     imid = (imax + imin) / 2             # <<<<<<<<<<<<<<
 *     while (imax > imin + 1):
 ...
 */
    __pyx_v_imid = __Pyx_div_long((__pyx_v_imax + __pyx_v_imin), 2);

    /* "getCoordsUtil.pyx":39
 *     imax = nPos
 *     imid = (imax + imin) / 2
 *     while (imax > imin + 1):             # <<<<<<<<<<<<<<
 *       d = seqPos[imid]-queryPos[k]
 ...
 */
    while (1) {
      __pyx_t_7 = ((__pyx_v_imax > (__pyx_v_imin + 1)) != 0);
      if (!__pyx_t_7) break;

      /* "getCoordsUtil.pyx":40
 *     imid = (imax + imin) / 2
 *     while (imax > imin + 1):
 *       d = seqPos[imid]-queryPos[k]             # <<<<<<<<<<<<<<
 *       if (d==0):
 *         imin = imid
 */
      __pyx_t_10 = __pyx_v_imid;
      __pyx_t_11 = __pyx_v_k;
      __pyx_v_d = ((*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_seqPos.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_seqPos.diminfo[0].strides)) - (*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_queryPos.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_queryPos.diminfo[0].strides)));

      /* "getCoordsUtil.pyx":41
 *     while (imax > imin + 1):
 *       d = seqPos[imid]-queryPos[k]
 *       if (d==0):             # <<<<<<<<<<<<<<
 *         imin = imid
 ...
 *         break
 */
        __pyx_v_imin = __pyx_v_imid;

        /* "getCoordsUtil.pyx":43
 *       if (d==0):
 *         imin = imid
 *         imax = imid             # <<<<<<<<<<<<<<
 *         break
 ...
 * 
 */
    __pyx_t_7 = (((__pyx_v_imax - __pyx_v_imin) == 2) != 0);
    if (__pyx_t_7) {

      /* "getCoordsUtil.pyx":53
 *     # necessary because of how we define the while loop. could probably make more elegant
 *     if ((imax - imin) == 2):
 *       imax = imin + 1             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_v_a = __pyx_v_imin;

    /* "getCoordsUtil.pyx":56
 * 
 *     a = imin
 *     b = imax             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_b = __pyx_v_imax;

    /* "getCoordsUtil.pyx":58
 *     b = imax
 * 
 *     dA = seqPos[a] - queryPos[k]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_v_dA = ((*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_seqPos.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_seqPos.diminfo[0].strides)) - (*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_queryPos.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_queryPos.diminfo[0].strides)));

    /* "getCoordsUtil.pyx":59
 * 
 *     dA = seqPos[a] - queryPos[k]
 *     dB = seqPos[b] - queryPos[k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_v_dB = ((*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_seqPos.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_seqPos.diminfo[0].strides)) - (*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_queryPos.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_queryPos.diminfo[0].strides)));

    /* "getCoordsUtil.pyx":61
 *     dB = seqPos[b] - queryPos[k]
 * 
 *     dMin = min(abs(dA), abs(dB))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_16 = abs(__pyx_v_dB); if (unlikely(__pyx_t_16 == ((int)-1))) __PYX_ERR(0, 61, __pyx_L1_error)
    __pyx_t_17 = abs(__pyx_v_dA); if (unlikely(__pyx_t_17 == ((int)-1))) __PYX_ERR(0, 61, __pyx_L1_error)
    if (((__pyx_t_16 < __pyx_t_17) != 0)) {
      __pyx_t_18 = __pyx_t_16;
    } else {
      __pyx_t_18 = __pyx_t_17;
    }
    __pyx_v_dMin = __pyx_t_18;

    /* "getCoordsUtil.pyx":110
 * 
 ...
 *         p[k,j] =  coords[a,j]
 */
    __pyx_t_7 = ((__pyx_v_a == __pyx_v_b) != 0);
    if (__pyx_t_7) {

      /* "getCoordsUtil.pyx":111
 *     #calculate coordinates
 *     if a == b:
 *       for j in range(3):             # <<<<<<<<<<<<<<
 *         p[k,j] =  coords[a,j]
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_13getCoordsUtil_FTYPE_t *, __pyx_pybuffernd_p.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_p.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_p.diminfo[1].strides) = (*__Pyx_BufPtrStrided2d(__pyx_t_13getCoordsUtil_FTYPE_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_coords.diminfo[0].strides, __pyx_t_21, __pyx_pybuffernd_coords.diminfo[1].strides));
      }
 ...
 */
    /*else*/ {
      ...
      __pyx_t_26 = ((float)((*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_seqPos.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_seqPos.diminfo[0].strides)) - (*__Pyx_BufPtrStrided1d(__pyx_t_13getCoordsUtil_DTYPE_t *, __pyx_pybuffernd_seqPos.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_seqPos.diminfo[0].strides))));
      if (unlikely(__pyx_t_26 == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 115, __pyx_L1_error)
      }
      __pyx_v_f = (((float)__pyx_v_dMin) / __pyx_t_26);

      /* "getCoordsUtil.pyx":117
 *       f = <float>dMin/<float>(seqPos[b]-seqPos[a])
 * 
 *       for j in range(3):             # <<<<<<<<<<<<<<
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_13getCoordsUtil_FTYPE_t *, __pyx_pybuffernd_p.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_p.diminfo[0].strides, __pyx_t_32, __pyx_pybuffernd_p.diminfo[1].strides) = (((1.0 - __pyx_v_f) * (*__Pyx_BufPtrStrided2d(__pyx_t_13getCoordsUtil_FTYPE_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_coords.diminfo[0].strides, __pyx_t_28, __pyx_pybuffernd_coords.diminfo[1].strides))) + (__pyx_v_f * (*__Pyx_BufPtrStrided2d(__pyx_t_13getCoordsUtil_FTYPE_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_coords.diminfo[0].strides, __pyx_t_30, __pyx_pybuffernd_coords.diminfo[1].strides))));
      }
    }
    __pyx_L10:;
  }

  /* "getCoordsUtil.pyx":120
 *         p[k,j] = (1.0-f) * coords[a,j] + f * coords[b,j]
 * 
 *   return p             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_queryPos.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_seqPos.rcbuffer->pybuffer);
...
static int __pyx_pymod_exec_getCoordsUtil(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_getCoordsUtil},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_error_getInterpolatedCoords_sequ, __pyx_k_error_getInterpolatedCoords_sequ, sizeof(__pyx_k_error_getInterpolatedCoords_sequ), 0, 0, 1, 0},
  {&__pyx_n_s_f, __pyx_k_f, sizeof(__pyx_k_f), 0, 0, 1, 1},
  {&__pyx_n_s_file, __pyx_k_file, sizeof(__pyx_k_file), 0, 0, 1, 1},
  {&__pyx_n_s_float64, __pyx_k_float64, sizeof(__pyx_k_float64), 0, 0, 1, 1},
  {&__pyx_n_s_getCoordsUtil, __pyx_k_getCoordsUtil, sizeof(__pyx_k_getCoordsUtil), 0, 0, 1, 1},
  {&__pyx_kp_s_getCoordsUtil_pyx, __pyx_k_getCoordsUtil_pyx, sizeof(__pyx_k_getCoordsUtil_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_getInterpolatedCoordsSort, __pyx_k_getInterpolatedCoordsSort, sizeof(__pyx_k_getInterpolatedCoordsSort), 0, 0, 1, 1},
  {&__pyx_n_s_i, __pyx_k_i, sizeof(__pyx_k_i), 0, 0, 1, 1},
  {&__pyx_n_s_imax, __pyx_k_imax, sizeof(__pyx_k_imax), 0, 0, 1, 1},
  {&__pyx_n_s_imid, __pyx_k_imid, sizeof(__pyx_k_imid), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_nQuery, __pyx_k_nQuery, sizeof(__pyx_k_nQuery), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_queryPos, __pyx_k_queryPos, sizeof(__pyx_k_queryPos), 0, 0, 1, 1},
  {&__pyx_n_s_range, __pyx_k_range, sizeof(__pyx_k_range), 0, 0, 1, 1},
  {&__pyx_n_s_seqPos, __pyx_k_seqPos, sizeof(__pyx_k_seqPos), 0, 0, 1, 1},
 ...
 *                               np.ndarray[dtype=DTYPE_t, ndim=1] queryPos):
 */
  __pyx_tuple__8 = PyTuple_Pack(20, __pyx_n_s_seqPos, __pyx_n_s_coords, __pyx_n_s_queryPos, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_nPos, __pyx_n_s_nQuery, __pyx_n_s_d, __pyx_n_s_dMin, __pyx_n_s_dA, __pyx_n_s_dB, __pyx_n_s_dMax, __pyx_n_s_f, __pyx_n_s_p, __pyx_n_s_imin, __pyx_n_s_imax, __pyx_n_s_imid); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(3, 0, 20, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_getCoordsUtil_pyx, __pyx_n_s_getInterpolatedCoordsSort, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgetCoordsUtil(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgetCoordsUtil(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_getCoordsUtil(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_getCoordsUtil(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_getCoordsUtil(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'getCoordsUtil' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_getCoordsUtil(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("getCoordsUtil", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_getCoordsUtil) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "getCoordsUtil")) {
      if (unlikely(PyDict_SetItemString(modules, "getCoordsUtil", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_FTYPE, __pyx_t_1) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *                               np.ndarray[dtype=DTYPE_t, ndim=1] queryPos):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13getCoordsUtil_1getInterpolatedCoordsSort, NULL, __pyx_n_s_getCoordsUtil); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_getInterpolatedCoordsSort, __pyx_t_1) < 0) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init getCoordsUtil", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init getCoordsUtil");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
